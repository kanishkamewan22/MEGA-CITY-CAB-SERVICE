...
public class Vehicleupdate {
    ...
    private InputStream vehiclePhoto;  // To store the main vehicle photo
    private InputStream vehiclePhototwo;  // To store the second vehicle photo (if any)

    // Constructor to initialize the Vehicle object
    public Vehicleupdate(int id, String vehicleName, String vehicleModel, String vehicleType, String fuelType,
